...
//////////////for input
            ...
            let E= [[0,1,45],[0,2,35],[0,3,55],[0,4,65],[0,5,25],[0,6,117],[0,9,95],[0,10,97],[0,16,88],[0,18,98],
                    [1,7,67],[1,8,121],[1,9,15],[1,10,85],[1,0,45],[2,0,35],[3,0,55],[4,0,65],[5,0,25],[6,0,117],[9,0,95],[10,0,97],[16,0,88],[18,0,98],
                    [2,13,15],[2,14,5],[2,15,85],[2,16,35],
                    [13,2,15],[14,2,5],[15,2,85],[16,2,35],
                    [3,17,21],[3,16,5],[3,18,15],
                    [17,3,21],[16,3,5],[18,3,15],
                    [4,1,11],[4,8,21],[4,19,21],
                    [5,6,92],[5,7,21],[5,18,11],[5,16,101],
                    [6,2,21],[6,3,121],[6,18,71],[6,17,21],
                    [12,2,37],[12,15,43],
                    [11,20,76],[11,1,17],[11,10,61]   
                    
                ];
            let src_1=hash[source_city];
            console.log("sorce pint",src_1);
            let graph1 = createGraph(len,E);
            let distances = dijkstra(graph1,len,src_1);//after len put src
            ...
            let vertices_name=[];
            let dest=hash[destination_city];
            while(dest!=src_1)
            {
                res.push({from:dest,to:distances[dest][1],color:'green',label:String(54)});
                // vertices.push({id:i,label:cities[i]});
